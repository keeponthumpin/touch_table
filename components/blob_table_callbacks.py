def onTableChange(dat):
    ...
    ext = parent.blobtrack.extensions[0]  # Reference to your extension
    ...
    for i in range(1, dat.numRows):
        ...
        if blob_id not in ext.ActiveBlobs:
            if active or revived:
                ...
                ext.SendOSC('/touch/begin', blob_id, u, v)
            ...
            if lost or expired:
                ...
                ext.SendOSC('/touch/end', blob_id, u, v)
    ...
    for missing_id in missing_ids:
        ...
        ext.SendOSC('/touch/end', missing_id, stored_blob.u, stored_blob.v)
        del ext.active_blobs.val[missing_id]
        ext.active_blobs.modified()

def onRowChange(dat, row):
    """Called when a row changes - use onTableChange instead"""
    pass
